...
const nav = [
  ...
  { to: '/flows', label: 'Flows', icon: FlowsIcon },
...
export default function Layout() {
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Sidebar */}
      <aside className="w-56 flex-shrink-0 bg-navy-900 flex flex-col">
        <div className="px-5 py-5">
          <h1 className="text-white text-xl font-bold tracking-tight">Klaflow</h1>
          <p className="text-gray-400 text-xs mt-0.5">Real-time segmentation</p>
        </div>
